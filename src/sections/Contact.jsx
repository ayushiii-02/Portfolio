...
const Contact = () => {
    ...
    try {
      await emailjs.send(
        ...
        "template_evzpvq6",
        {
          ...
          to_email: "ayushiii2212@gmail.com",
  ...
  return (
    <section id="contact" className="mt-4 pb-10 px-4 flex justify-center relative" >
      {/* <Particles /> */}
        ...
        <form className="w-full" onSubmit={handleSubmit}>
          ...
          <div className="mb-5">
            ...
            <input
              ...
              type="email"
              className="field-input field-input-focus"
              placeholder="ayushixyz@gmail.com"
              required
              autoComplete="email"
